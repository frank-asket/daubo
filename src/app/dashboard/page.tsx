...
export default function DashboardPage() {
  return (
    <div className="space-y-6 p-4 sm:p-6 lg:p-8">
      <section className="rounded-2xl border border-emerald-500/20 bg-gradient-to-b from-emerald-500/10 via-zinc-950 to-black p-5 sm:p-6">
      ...
      <BackendStatus />
      <section className="rounded-2xl border border-zinc-800 bg-[#080808] p-3 sm:p-4">
        <DiscoverWorkspace />
      </section>
    </div>
  );
